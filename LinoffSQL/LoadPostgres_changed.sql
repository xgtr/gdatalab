...
COPY Calendar FROM 'E:\1unzipfolder\DALinoff\data\Calendar.txt'
...
COPY Campaigns FROM 'E:\1unzipfolder\DALinoff\data\Campaigns.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' CSV;
...
COPY Customers FROM 'E:\1unzipfolder\DALinoff\data\Customers.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' CSV;
...
COPY OrderLines FROM 'E:\1unzipfolder\DALinoff\data\OrderLines.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' CSV;
...
COPY Orders FROM 'E:\1unzipfolder\DALinoff\data\Orders.txt'
...
COPY Products FROM 'E:\1unzipfolder\DALinoff\data\Products.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' CSV;
...
COPY Subscribers FROM 'E:\1unzipfolder\DALinoff\data\Subscribers.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' CSV;
...
COPY ZipCensus FROM 'E:\1unzipfolder\DALinoff\data\ZipCensus.txt'
...
COPY ZipCounty FROM 'E:\1unzipfolder\DALinoff\data\ZipCounty.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' ENCODING 'LATIN1'  CSV;
